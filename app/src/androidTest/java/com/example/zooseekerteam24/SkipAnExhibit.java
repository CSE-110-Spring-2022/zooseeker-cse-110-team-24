...
public class SkipAnExhibit {
    ...
    public void skipAnExhibit() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.nextExhibit), withText("Navigating To: Entrance and Exit Gate\nDistance: 1100.0 ft"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Navigating To: Entrance and Exit Gate\nDistance: 1100.0 ft")));
